...
async def get_offer(request):
    global remote_offer_session_desc
    if remote_offer_session_desc is not None:
        print("get_offer")
        return web.Response(
            content_type="application/json",
            text=json.dumps(
                remote_offer_session_desc
            ),
        )
    else:
...
async def get_stream(request):
    global web_offer_session_desc, remote_offer_session_desc
    params = await request.json()
    remote_offer_session_desc = {
        "sdp": params["sdp"],
        "type": params["type"]
...
remote_offer_session_desc = None
...
if __name__ == "__main__":
    ...
    app.router.add_post("/answer", set_answer)
